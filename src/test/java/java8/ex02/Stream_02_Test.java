...
public class Stream_02_Test {
    ...
    public void test_map() throws Exception {
        ...
        List<Customer> result = orders.stream().map(a -> a.getCustomer()).distinct().collect(Collectors.toList());
    ...
    public void test_flatmap() throws Exception {
        ...
        IntSummaryStatistics result = orders.stream().flatMapToInt(a -> a.getPizzas().stream().mapToInt(Pizza::getPrice)).summaryStatistics();
