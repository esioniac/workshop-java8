...
public class Stream_03_Test {
    ...
    public void test_grouping() throws Exception {
        ...
        Map<Customer, List<Order>> result = orders.stream().collect(Collectors.groupingBy(a -> a.getCustomer(), Collectors.toList()));
    ...
    public void test_mapping() throws Exception {
        ...
        Map<Gender, String> result = customers.stream().sorted(Comparator.comparing(Customer::getFirstname)).collect(Collectors.toMap(Customer::getGender, Customer::getFirstname, (a,b) -> a+"|"+b));
